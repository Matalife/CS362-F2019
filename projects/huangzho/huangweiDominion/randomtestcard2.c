...
int main () {
    ...
    printf("Testing the function minionCardEffect():\n\n");
    ...
    while (done !=0) {
        ...
        // call minionCardEffect with the test game
        minionCardEffect(choice1, choice2, &testGame, handPos, currentPlayer);
        ...
        printf("****************************** function minionCardEffect test end **********************************\n\n");
