...
int main()
{
    ...
    minionCardEffect(&G, 0, 0, 3, player); // play the card
    ...
    G.hand[player][3] = minion;
    int coins = G.coins;
    minionCardEffect(&G, 1, 0, 3, player); // play the card for choice 1
    ...
    initializeGame(num_player, k, seed, &G);
    G.hand[player][3] = minion;
    minionCardEffect(&G, 1, 0,  3, player); // play the card
    ...
    minionCardEffect(&G, 0, 1, 3, player); 
