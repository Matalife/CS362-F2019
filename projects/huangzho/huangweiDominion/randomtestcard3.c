...
int main () {
    ...
    printf("Testing the function tributeCardEffect():\n\n");
    ...
    while (done !=0) {
        ...
        // call tributeCardEffect with the test game
        tributeCardEffect(&testGame, nextPlayer,  currentPlayer,tributeRevealedCards);
        ...
        printf("******************************function tributeCardEffect() test end **********************************\n\n");
