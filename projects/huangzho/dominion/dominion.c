...
static int Effect_baron(int choice1, struct gameState *state, int currentPlayer)
{
...
static int Effect_minion(int choice1, int choice2, int currentPlayer, struct gameState *state, int handPos)
{
     //+1 action
        state->numActions++;
...
static int Effect_ambassador(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
...
static int Effect_tribute(struct gameState *state, int handPos){
    int currentPlayer = whoseTurn(state);
...
static int Effect_mine(int choice1, int choice2, struct gameState *state, int handPos){
     int currentPlayer = whoseTurn(state);     
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
       return Effect_mine(choice1, choice2, state, handPos);
    ...
    case baron:
        return Effect_baron(choice1, state, currentPlayer);
    ...
    case minion:
        return Effect_minion(choice1, choice2, currentPlayer, state, handPos);
    ...
    case tribute:
       retrun Effect_tribute(state, handPos);
    case ambassador:
        return Effect_ambassador(choice1, choice2, state, handPos, currentPlayer);
